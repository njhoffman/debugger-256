...
const createDebug = (subsystem = '') => ({
  _dbg: output.bind(undefined, -1, subsystem),
  fatal: output.bind(undefined, 0, subsystem),
  error: output.bind(undefined, 1, subsystem),
  warn: output.bind(undefined, 2, subsystem),
  log: output.bind(undefined, 3, subsystem),
  info: output.bind(undefined, 4, subsystem),
  output: output.bind(undefined, 5, subsystem),
  trace: output.bind(undefined, 6, subsystem),
  showColors,
  init,
  reset,
});
